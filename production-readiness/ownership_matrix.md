...
|---|---|---|---|---|---|
| Security | Security Engineering | Platform Security | Security Lead | Incident commander for launch-blocking security regressions | `make gate-security` |
...
| Data Lifecycle | Data Platform | SRE | Data Lead | Data governance owner for retention, migration, backup, or deletion gaps | `make db-migrate-check` |
