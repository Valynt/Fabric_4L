...
LAYER_PARITY_RULES: dict[str, dict[str, object]] = {
    ...
    "layer4": {
        "canonical_routes": REPO_ROOT / "services/layer4-agents/src/layer4_agents/api/routes/__init__.py",
        "service_routes": REPO_ROOT / "services/layer4-agents/src/layer4_agents/api/routes/__init__.py",
        "service_main": REPO_ROOT / "services/layer4-agents/src/layer4_agents/api/main.py",
        "canonical_import": "layer4_agents.api.routes",
        "service_interface": REPO_ROOT / "services/layer4-agents/src/layer4_agents/services/business_case_service.py",
        "repository_interface": REPO_ROOT / "services/layer4-agents/src/layer4_agents/database.py",
        "middleware_anchor": REPO_ROOT / "services/layer4-agents/src/layer4_agents/api/main.py",
    },
    "layer5": {
