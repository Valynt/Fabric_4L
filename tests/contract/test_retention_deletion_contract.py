...
L1_CRAWL_MAINTENANCE_TASKS = (
    REPO_ROOT / "services/layer1-ingestion/src/layer1_ingestion/shared/crawl_maintenance_tasks.py"
)
...
def test_cleanup_task_default_and_delete_semantics_present():
    text = L1_CRAWL_MAINTENANCE_TASKS.read_text()
