...
from scripts.ci import check_trivy_ignore_policy
...
def test_real_trivyignore_file_is_valid() -> None:
    ...
    violations = check_trivy_ignore_policy.validate_trivy_ignore(
...
def test_detects_expired_waivers() -> None:
    ...
    violations = check_trivy_ignore_policy.validate_trivy_ignore(
        sample, reference_date=datetime.date(2025, 1, 1)
    )
