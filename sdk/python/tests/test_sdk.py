...
class TestSDKImports:
    ...
    def test_import_generated_clients(self) -> None:
...
class TestClientInitialization:
    ...
    def test_client_init_with_url(self) -> None:
    ...
    def test_client_init_with_api_key(self) -> None:
        ...
        client = ValueFabricClient(base_url="http://localhost:8004", api_key="test-api-key")
        assert client is not None
...
class TestGeneratedClients:
    ...
    def test_l3_client_init(self) -> None:
    ...
    def test_l4_client_init(self) -> None:
...
class TestSDKIntegration:
    ...
    def test_health_command_live(self) -> None:
        """Health command against real API."""
        result = runner.invoke(app, ["health"])
        assert result.exit_code == 0

    def test_client_health_live(self) -> None:
