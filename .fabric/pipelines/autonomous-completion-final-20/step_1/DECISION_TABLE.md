...
| GAP-13 | — | agents/skills promotion | Open PR with shim CDR | `external_impl_owner` | architects + L4 | no | no | #1683 | already 76 files | Leave to #1683 / pull in | |
