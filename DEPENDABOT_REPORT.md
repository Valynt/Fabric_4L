...
*   **[PR 1601](https://github.com/Valynt/Fabric_4L/pull/1601): chore(deps): bump vite from 7.3.6 to 8.2.2**
...
*   **[PR 1608](https://github.com/Valynt/Fabric_4L/pull/1608): chore(deps): bump zod from 3.25.76 to 4.5.1 in /packages/config**
...
*   **[PR 1606](https://github.com/Valynt/Fabric_4L/pull/1606): chore(deps): bump react-resizable-panels from 3.0.6 to 4.12.3 in /apps/web**
...
*   **[PR 1603](https://github.com/Valynt/Fabric_4L/pull/1603): chore(deps): bump recharts from 2.15.4 to 3.10.1**
...
*   **[PR 1602](https://github.com/Valynt/Fabric_4L/pull/1602): chore(deps): bump @testing-library/jest-dom from 6.10.0 to 7.0.1**
...
*   **[PR 1607](https://github.com/Valynt/Fabric_4L/pull/1607): chore(deps): bump web-vitals from 4.2.4 to 6.2.1 in /apps/web**
...
*   **[PR 1599](https://github.com/Valynt/Fabric_4L/pull/1599): chore(deps): bump @types/node from 20.19.43 to 26.4.0 in /services/value-studio**
...
*   **[PR 1633](https://github.com/Valynt/Fabric_4L/pull/1633): chore(deps): bump the routine-minor-patch group across 1 directory with 18 updates**
    *   **Recommendation:** Merge if CI passes. Grouped updates reduce noise.
*   **[PR 1629](https://github.com/Valynt/Fabric_4L/pull/1629): chore(deps): bump the routine-minor-patch group across 1 directory with 11 updates**
    *   **Recommendation:** Merge if CI passes.
*   **[PR 1604](https://github.com/Valynt/Fabric_4L/pull/1604): chore(deps): bump lucide-react from 0.453.0 to 1.37.0**
    *   **Recommendation:** Merge if CI passes; mostly icon additions/fixes.
*   **[PR 1598](https://github.com/Valynt/Fabric_4L/pull/1598): chore(deps): update msgpack requirement from >=1.0.8 to >=1.2.2 in /tests**
    *   **Recommendation:** Merge if CI passes.
*   **[PR 1597](https://github.com/Valynt/Fabric_4L/pull/1597): chore(deps): update anyio requirement from >=4.0.0 to >=4.14.2 in /tests**
    *   **Recommendation:** Merge if CI passes.
...
*   **[PR 1616](https://github.com/Valynt/Fabric_4L/pull/1616): chore(deps-dev): bump pnpm from 10.18.1 to 10.34.5 in /docs/archive/frontend-root-2026-05-02/source-snapshot in the npm_and_yarn group across 1 directory**
