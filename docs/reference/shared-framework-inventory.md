...
These tests fail fast for drift in middleware wiring, exception envelope registration, tenant context references, rollout/idempotency declarations, and health endpoint declarations. They intentionally validate static entrypoint markers rather than runtime behavior.
