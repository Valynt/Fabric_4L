...
| Billing | `services/layer4-agents/src/layer4_agents/services/billing_service.py` (and `api/routes/billing*.py`) | Legacy `services/billing/` removed 2026-08-27 (COMPAT-BILL-001); parallel `services/layer7-billing/` removed 2026-10-15 (COMPAT-L4-003) | `services/layer4-agents/src/layer4_agents/` | Billing Maintainers (Layer 4) |
