...
| `dev:layer4` | `infisical run --env=dev --path=/shared --path=/infra --path=/layer4-agents -- uvicorn layer4_agents.api.main:app --app-dir services/layer4-agents/src --reload` | Dev server |
