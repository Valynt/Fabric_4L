...
| Python container base | `python:3.11.15-slim-bookworm` (`python:3.11.15-slim-bookworm`) | Maintained service Dockerfiles and full/uv service variants | `FROM python@sha256:...` in service Dockerfiles |
