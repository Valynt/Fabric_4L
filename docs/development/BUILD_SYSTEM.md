...
| Python container base | `python@sha256:d1e9ca7c4e78d1e8ecadb5d44bfc8e956e7a65b659a9950f569f243d72b326d0` (`python:3.11-slim-bookworm`) | Maintained service Dockerfiles and full/uv service variants | `FROM python:3.11-slim@sha256:...` (optionally prefixed with `docker.io/`) / `ARG BASE_IMAGE=python@sha256:...` |
