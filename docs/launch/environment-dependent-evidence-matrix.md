...
| Rollback and restore drill | REQUIRES_ENVIRONMENT | SRE owner | Rollback command transcript, restore proof, data-integrity check, timing result, and approval record. Cold-site staging failure drills must follow `docs/troubleshooting/runbooks/incident/cold-site-dr-sync-strategy.md` and record measured RTO/RPO. | Rollback and restore meet the release recovery target and leave no unreconciled data changes. **Minimum evidence:** redacted transcript, before/after data-integrity check, actual recovery time versus target, RPO measurement, and SRE owner approval. | Local drill evidence in `signoff-evidence/p0-rollback-20260613.json` documents the viable rollback doctrine. Production-like rollback and cold-site DR rehearsal evidence still required. |
