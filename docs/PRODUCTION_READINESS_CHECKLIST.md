...
| R12 | **Release smoke gate** | `make test-backend-integrated-release-smoke` (CI: `pr-checks.yml` / `integration-checks`) validates the L1–L6 release-smoke stack; artifacts under `artifacts/release_smoke/` | P0 | ✅ PASS |
