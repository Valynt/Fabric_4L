...
| S5-4 | Live trace receipt tests pass with the required services and collector/backend running. | Start billing/Layer 7 on `localhost:8000`, Layer 2.5 on `localhost:8007`, and the trace backend, then rerun trace receipt tests. |
