...
Variables: `VITE_API_BASE`, `VITE_L1_PREFIX` … `VITE_L7_PREFIX`,
`VITE_ENABLE_QUERY_DEVTOOLS`, `VITE_API_LOG_LEVEL`, `VITE_ENVIRONMENT`,
`VITE_APP_VERSION`, `VITE_JAEGER_ENDPOINT`, `VITE_ENABLE_WEB_VITALS`
