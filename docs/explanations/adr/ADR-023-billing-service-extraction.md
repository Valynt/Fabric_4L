...
**Status:** Superseded — Layer 4 ratified as canonical single billing owner (2026-10-15); `services/layer7-billing/` deleted (Brooks-Lint R3 Knowledge Duplication resolution); `services/billing/` removed 2026-08-27 (COMPAT-BILL-001)
**Date:** May 29, 2026
...
This ADR records the historical extraction proposal, its subsequent supersession, and the final 2026-10-15 consolidation:
...
**Final ratified decision (2026-10-15):**
...
- **COMPAT-L4-003:** Resolved on 2026-10-15. L4 billing routes are no longer proxies or shims; they are the sole canonical implementation. COMPAT-L4-003 is archived.
...
- [x] ADR-023 (this document) merged to `main`; final single-owner resolution recorded on 2026-10-15.
