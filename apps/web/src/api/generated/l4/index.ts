...
export interface paths {
    ...
    "/v1/admin/tenant-overview": {
        ...
        /**
         * Get Tenant Overview
         * @description Get a paginated cross-tenant overview.
         *
         ...
         */
        get: operations["get_tenant_overview_v1_admin_tenant_overview_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/runtime/health": {
        ...
        /**
         * Runtime Health
         * @description Report runtime readiness without exposing cross-tenant labels.
         */
        get: operations["runtime_health_v1_runtime_health_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/runtime/types": {
        ...
        /**
         * Runtime Types
         * @description Discover workflows, tenant-visible tools, and registered providers.
         */
        get: operations["runtime_types_v1_runtime_types_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/runtime/runs": {
        ...
        /**
         * List Runtime Runs
         * @description List only runs owned by the authenticated tenant.
         */
        get: operations["list_runtime_runs_v1_runtime_runs_get"];
        put?: never;
        /**
         * Submit Runtime Run
         * @description Submit a tenant-scoped runtime run.
         */
        post: operations["submit_runtime_run_v1_runtime_runs_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/runtime/runs/{run_id}": {
        ...
        /**
         * Get Runtime Run
         * @description Get a run or return a tenant-safe not-found response.
         */
        get: operations["get_runtime_run_v1_runtime_runs__run_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/runtime/runs/{run_id}/cancel": {
        ...
        /**
         * Cancel Runtime Run
         * @description Cancel a run only when it belongs to the authenticated tenant.
         */
        post: operations["cancel_runtime_run_v1_runtime_runs__run_id__cancel_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/runtime/runs/{run_id}/resume": {
        ...
        /**
         * Resume Runtime Run
         * @description Resume a tenant-owned run with an explicit checkpoint contract.
         */
        post: operations["resume_runtime_run_v1_runtime_runs__run_id__resume_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface operations {
    ...
    get_tenant_overview_v1_admin_tenant_overview_get: {
        parameters: {
            query?: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["TenantOverviewResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    runtime_health_v1_runtime_health_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    runtime_metrics_v1_runtime_metrics_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    runtime_types_v1_runtime_types_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RuntimeTypesResponse"];
                };
            };
        };
    };
    list_runtime_runs_v1_runtime_runs_get: {
        parameters: {
            query?: {
                workflow_type?: string | null;
                status?: string | null;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["RuntimeRunListResponse"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    submit_runtime_run_v1_runtime_runs_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_runtime_run_v1_runtime_runs__run_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    cancel_runtime_run_v1_runtime_runs__run_id__cancel_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    resume_runtime_run_v1_runtime_runs__run_id__resume_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
