...
const tenantStdPolicy = (id: string) => ({ requiresAuth: true, tenantScoped: true, requiredPermissions: [] as string[], fallbackRoute: "/home", analyticsRouteId: id });
const tenantAdvPolicy = (id: string) => ({ requiresAuth: true, tenantScoped: true, requiredPermissions: ["ontology:read"], fallbackRoute: "/home", analyticsRouteId: id });
const tenantAdminPolicy = (id: string) => ({ requiresAuth: true, tenantScoped: true, requiredPermissions: ["user:manage"], fallbackRoute: "/home", analyticsRouteId: id });
const accountStdPolicy = (id: string) => ({ requiresAuth: true, tenantScoped: true, accountScoped: true, requiredPermissions: ["account:read"], fallbackRoute: "/home", analyticsRouteId: id });
...
const accountAdvPolicy = (id: string) => ({ requiresAuth: true, tenantScoped: true, accountScoped: true, requiredPermissions: ["account:read", "ontology:read"], fallbackRoute: "/home", analyticsRouteId: id });
