        ...
        for signal in context.signals:
            if signal.signal_type == "funding":
                ...
                hypotheses.append(ValueHypothesis(
                    ...
                    hypothesis_text="Recent funding round detected. They are likely in growth mode and need scalable systems to support Expansion.",
                ...
                hypotheses.append(ValueHypothesis(
                    ...
                    hypothesis_text="New leadership detected. Executive transitions are major catalysts for buying new operational platforms.",
