...
This is the parent skill for the Superpowers agentic software development methodology.
Each child skill handles a specific phase or practice. Invoke the child skill that matches your current task.

## Children

- `using-superpowers` — meta skill: how to discover and invoke Superpowers skills
